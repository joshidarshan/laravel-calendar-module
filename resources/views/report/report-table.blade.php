@extends('layouts.app')
@section('topbar-title', 'Report Table')
...
@section('content')
    ...
    <div class="filter-bar">
        ...
        <div class="filter-left">
            <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#dayPickerModal">
                Day
            </button>
            ...
            <a href="{{ route('report.table', ['filter' => 'all']) }}" class="btn btn-outline-secondary">
                All
            </a>
        </div>
    ...
    <div class="modal fade" id="weekPickerModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <input type="week" class="form-control mx-auto" style="max-width:240px"
    ...
    <div class="modal fade" id="monthPickerModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <input type="month" class="form-control mx-auto" style="max-width:240px"
    ...
    @php
        $totalTasks = collect($employeeWise)->sum(
            fn($e) => $e['completed'] + $e['pending'] + $e['overdue'] + $e['in_progress'],
        );
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-2">
            <div class="summary-card">
                ...
                <div class="summary-value text-primary">{{ $score }}%</div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="summary-card">
        ...
        <div class="col-md-2">
            <div class="summary-card">
                <div class="summary-title">In Time</div>
