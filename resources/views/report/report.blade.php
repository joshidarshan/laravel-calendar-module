...
@section('topbar-buttons')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="btn-group view-group">
            ...
            <a href="#" class="btn btn-outline-dark" id="btnDownload">
...
@section('content')
    ...
    <div id="chartView" class="d-none">
        <div class="row g-3 mb-3">
            <div class="col-md-4">
                <div class="card p-3">
                    <h6 class="text-center mb-3">Status Chart</h6>
                    <canvas id="statusChart"></canvas>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card p-3">
                    <h6 class="text-center mb-3">Completion Chart</h6>
                    <canvas id="completionChart"></canvas>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card p-3">
                    <h6 class="text-center mb-3">Timing Chart</h6>
        ...
        <div class="row g-3">
            <div class="col-md-6">
                <div class="card p-3">
                    <h6>Employee Wise</h6><canvas id="employeeChart"></canvas>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card p-3">
                    <h6>Category Wise</h6><canvas id="categoryChart"></canvas>
                </div>
            </div>
        </div>
    </div>
...
@push('scripts')
    ...
    <script>
        ...
        function renderCharts(data) {
            ...
            [statusChart, completionChart, timingChart, employeeChart, categoryChart].forEach(c => {
                if (c) c.destroy();
            });
            ...
            statusChart = new Chart(document.getElementById('statusChart'), {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [totalPending, totalProgress, totalCompleted, totalOverdue],
            ...
            completionChart = new Chart(document.getElementById('completionChart'), {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [
                            totalCompleted,
                            data.reduce((sum, d) => sum + d.total, 0) - totalCompleted
                        ],
                    ...
                    plugins: {
                        datalabels: {
                            ...
                            formatter: (value, ctx) => {
                                ...
                                const percentage = ((value / sum) * 100).toFixed(1); // show 1 decimal
                                return percentage + '%';
                            },
                            font: {
                                weight: 'bold',
            ...
            timingChart = new Chart(document.getElementById('timingChart'), {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [
                            data.reduce((sum, d) => sum + d.total, 0) - totalOverdue, // On-Time
                ...
                options: {
                    plugins: {
                        datalabels: {
                            ...
                            formatter: (value, ctx) => {
                                const sum = ctx.chart.data.datasets[0].data.reduce((a, b) => a + b, 0);
                                const percentage = ((value / sum) * 100).toFixed(1); // 1 decimal
                                return percentage + '%';
                            },
                            font: {
                                weight: 'bold',
