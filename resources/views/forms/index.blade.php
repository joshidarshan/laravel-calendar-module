    ...
    <div class="modal-dialog modal-dialog-centered modal-md">
        <form id="createForm" class="needs-validation" novalidate>
            ...
            <div class="modal-content rounded-4 shadow-lg border-0">
                ...
                <!-- Header -->
                <div class="modal-header bg-primary text-white py-3 px-4 rounded-top d-flex justify-content-between align-items-center">
                ...
                <div class="modal-body p-4">
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" class="form-control form-control-lg rounded-pill border-primary" placeholder="Enter form name" required>
                    </div>
                </div>
